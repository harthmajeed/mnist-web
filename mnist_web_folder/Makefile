...
CYBULDE_DATA_PROCESSING_GCP_DOCKER_IMAGE = europe-west4-docker.pkg.dev/cybulde/cybulde/cybulde-data-processing:3e01ffcb-f82e-4a8e-80f2-b1003cff7b3e
CYBULDE_MODEL_GCP_DOCKER_IMAGE = europe-west4-docker.pkg.dev/cybulde/cybulde/cybulde-model:v1
